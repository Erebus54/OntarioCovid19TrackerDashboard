...
#setwd("C:/Users/patri/Documents/covid19/GIS Shiny App/COVID19_GIS/ShinyDashboard/")
library(rsconnect)
...
```{r}
fig <- plot_ly(x = ~ConfirmedPositives$Reported.Date, y = ~ConfirmedPositives$Total.Cases, type = 'scatter', mode = 'none', name = 'Total Cases', fill = 'tozeroy',
               fillcolor = '#FFC56C')
